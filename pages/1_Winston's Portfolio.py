...
def links_section():
    ...
    linedin_link=f'<a href="{info.my_linkedin_url}"><img src="{info.linkedin_image_url}" alt="LinkedIn" width="75" height="75"></a>'
    st.sidebar.markdown(linedin_link, unsafe_allow_html=True)
